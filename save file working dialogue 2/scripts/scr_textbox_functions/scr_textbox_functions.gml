function scr_set_defaults_for_text() {
	...
	// the *20 is the amount of degrees of wobbly... ness...
...
text[page_number] = _text;
	...
	switch(argument[1])
		...
		case "legor-embarrassed":
		speaker_sprite[page_number] = spr_legor_embarrassed;
		txtb_spr[page_number] = spr_textbox;
		break;
		
		case "legor-angry":
		speaker_sprite[page_number] = spr_legor_angry;
		txtb_spr[page_number] = spr_textbox;
		break;
		
		case "legor-content":
		speaker_sprite[page_number] = spr_legor_content;
		txtb_spr[page_number] = spr_textbox;
		break;
